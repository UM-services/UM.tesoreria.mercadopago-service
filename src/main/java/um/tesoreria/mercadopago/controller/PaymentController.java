package um.tesoreria.mercadopago.controller;

import jakarta.servlet.http.HttpServletRequest;
import lombok.RequiredArgsConstructor;
import org.springframework.http.ResponseEntity;
import org.springframework.web.bind.annotation.*;
import um.tesoreria.mercadopago.domain.dto.PaymentNotificationDto;
import um.tesoreria.mercadopago.service.PaymentService;
...
public class PaymentController {
    ...
    public ResponseEntity<String> listener(HttpServletRequest request,
            ...
            @RequestBody(required = false) PaymentNotificationDto notification) {
